...
def create_ab_testing(config: Optional[Config] = None) -> AbTesting:
    """Factory function to create ab_testing instance"""
    if config is None:
        config = Config()
    return AbTesting(config)
