...
def create_rbac_engine(config: Optional[Config] = None) -> RbacEngine:
    """Factory function to create rbac_engine instance"""
    if config is None:
        config = Config()
    return RbacEngine(config)
