...
@dataclass
class Config:
    """Configuration for api_documentation"""
    enabled: bool = True
    timeout: int = 30
...
def create_api_documentation(config: Optional[Config] = None) -> ApiDocumentation:
    """Factory function to create api_documentation instance"""
    if config is None:
        config = Config()
